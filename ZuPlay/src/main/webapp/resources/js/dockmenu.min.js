    ...
    e.fn.dockmenu = function(t) {
        ...
        return this.each(function() {
            ...
            e.each(r.buttons, function(t, n) {
                ...
                e("<li>").append(e("<a>").attr("href", this.href).attr("id",this.id).attr("class",this.class).append(e("<span>").html(this.title)).append(e("<img/>").attr("src", this.imgURL))).bind("click", this.onClick ? r : "").appendTo(c)
            });
            if (n === "tb") {
                e(l).width(r.width);
                e(c).width(r.width)
