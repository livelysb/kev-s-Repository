...
public class FriendVO {
	...
	private String type; // A or B type (A : playerNickname2가 신청자 / B :
							// playerNickname이 신청자)
	...
	public FriendVO(int friendSq, String playerNickname, String playerNickname2, String friendIsAccepted,
			String friendDate, String friendGender, boolean onOrOff, String type, List<PlayerItemDTO> playerItemDTO) {
		super();
	...
	public String toString() {
		return "FriendVO [friendSq=" + friendSq + ", playerNickname=" + playerNickname + ", playerNickname2="
				...
				+ ", friendGender=" + friendGender + ", onOrOff=" + onOrOff + ", type=" + type + ", playerItemDTO="
				+ playerItemDTO + "]";
	}
