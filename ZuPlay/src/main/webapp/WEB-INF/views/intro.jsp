    ...
    <header> 
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <hr>
                <p> 1%대 초저금리 시대 -  예금으로 돈버는 시대는 끝났다.<br> 게임으로 쉽게 배우는 주식</p>
                <p></p>
                <a href="#about" class="btn btn-primary btn-xl page-scroll">Game Start</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="light">
                    <p class="text-faded">실시간 주식정보를 통해 실제 주식거래를 하는 것 같은 느낌을 Up!<br>
                    870여개의 kospi 기업정보 등재!</p>
                    <a href="#services" class="page-scroll btn btn-default btn-xl sr-button">Game Start</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="services">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">100여 종의 다양한 아이템을 통한 커스터마이징</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row no-gutter popup-gallery">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="${url}/img/portfolio/fullsize/3.jpg" class="portfolio-box">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-center">
                    ...
                    <p><a href="mailto:your-email@your-domain.com">Zuplay.naver.com</a></p>
                </div>
            </div>
        </div>
    </section>
