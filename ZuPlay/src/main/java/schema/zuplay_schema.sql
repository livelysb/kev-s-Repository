...
create sequence pi_sq nocache;
	select * from (select * from player_item where player_nickname='김경원') m join item i on m.item_code=i.item_code;

insert into player_item values(pi_sq.nextval,'김경원','m_hair_09','T',1);
insert into player_item values(pi_sq.nextval,'김경원','m_eyes_00','T',2);
insert into player_item values(pi_sq.nextval,'김경원','m_hair_08','T',3);
insert into player_item values(pi_sq.nextval,'김경원','m_acc_02','T',4);
insert into player_item values(pi_sq.nextval,'김경원','f_cloth_03','T',5);
		select pi_index from player_item where player_nickname='김경원' order by pi_index; 
...
select * from (select rownum, item_code;

select * from (select	rownum,item_code,item_name,item_price,item_class,item_grade,item_img,item_gender from item
		where upper(item_gender)!='F' and lower(item_class)='clothes' and item_grade='common') where
		rownum between 1 and 8;

delete item ;
delete player_item;
insert into item values ('m_hair_00','기본남자머리',0,'hair','default','resources/img/avatar/head/hair-04.png','M');
insert into item values ('m_hair_01','석이머리',20000,'hair','common','resources/img/avatar/head/hair-15.png','M');
insert into item values ('m_hair_02','키도머리',20000,'hair','common','resources/img/avatar/head/hair-03.png','M');
insert into item values ('m_hair_03','터프머리',25000,'hair','common','resources/img/avatar/head/hair-05.png','M');
insert into item values ('m_hair_04','민수머리',35000,'hair','rare','resources/img/avatar/head/hair-07.png','M');
insert into item values ('m_hair_05','범이머리',40000,'hair','rare','resources/img/avatar/head/hair-09.png','M');
insert into item values ('m_hair_06','쉼표머리',45000,'hair','rare','resources/img/avatar/head/hair-10.png','M');
insert into item values ('m_hair_07','승이머리',45000,'hair','rare','resources/img/avatar/head/hair-16.png','M');
insert into item values ('m_hair_08','뾰족머리',45000,'hair','rare','resources/img/avatar/head/hair-02.png','M');
insert into item values ('m_hair_09','어린왕자머리',60000,'hair','uniq','resources/img/avatar/head/hair-12.png','M');

insert into item values ('m_eyes_00',	'기본눈',	0,	'eyes',	'default',	'resources/img/avatar/eyes/eyes-08.png',	'A'	);
insert into item values ('m_eyes_01','초롱눈',	15000,	'eyes',	'common','resources/img/avatar/eyes/eyes-01.png',	'A'	);
insert into item values ('m_eyes_02',	'용감눈',	25000,	'eyes',	'common','resources/img/avatar/eyes/eyes-06.png',	'M'	);
insert into item values ('m_eyes_03','웃는눈',	10000,	'eyes',	'common',	'resources/img/avatar/eyes/eyes-06.png',	'A'	);
insert into item values ('m_eyes_04',	'졸린눈',	10000,	'eyes',	'common',	'resources/img/avatar/eyes/eyes-07.png',	'A'	);
insert into item values ('m_eyes_05','유령신랑눈',	15000,	'eyes',	'common',	'resources/img/avatar/eyes/eyes-02.png',	'A'	);
insert into item values ('f_eyes_01',	'초롱눈	',	15000,	'eyes',	'common','resources/img/avatar/eyes/eyes-03.png',	'F');

insert into item values (	'f_hair_00','기본머리',	0	,'hair','default','resources/img/avatar/head/hair-17.png',	'F'	);
insert into item values (	'f_hair_01','다솜머리',	20000	,'hair','common','resources/img/avatar/head/hair-13.png',	'F'	);
insert into item values (	'f_hair_02','진주머리',	30000	,'hair','rare','resources/img/avatar/head/hair-01.png',	'F'	);
insert into item values (	'f_hair_03','상큼레몬머리',	30000	,'hair','rare','resources/img/avatar/head/hair-06.png',	'F'	);
insert into item values (	'f_hair_04','밀크머리',	60000	,'hair','uniq','resources/img/avatar/head/hair-08.png',	'F'	);
insert into item values (	'f_hair_05','인어머리',	70000	,'hair','uniq','resources/img/avatar/head/hair-11.png',	'F'	);
insert into item values (	'f_hair_06','오션머리',	65000	,'hair','uniq','resources/img/avatar/head/hair-14.png',	'F'	);

insert into item values (	'f_cloth_00','기본옷',	0	,'clothes','default','resources/img/avatar/body/clothes-08.png',	'F'	);
insert into item values (	'f_cloth_01','회색브이넥',	10000	,'clothes','common','resources/img/avatar/body/clothes-09.png',	'F'	);
insert into item values (	'f_cloth_02','기본정장',	20000	,'clothes','common','resources/img/avatar/body/clothes-10.png',	'F'	);
insert into item values (	'f_cloth_03','청멜빵',	25000	,'clothes','common','resources/img/avatar/body/clothes-07.png',	'F'	);
...
CREATE TABLE ITEM_MARKET (
  ...
  IM_AUCTION_END VARCHAR2(3) NOT NULL /* 진행중 여부 (T=진행중/F=종료/X=유찰)*/
);

select * from (select
		rownum,item_code,item_name,item_price,item_class,item_grade,item_img,item_gender
    from item
		where upper(item_gender)!='F' and item_class='hair' and item_grade='common') where
		rownum between '1' and '8';
